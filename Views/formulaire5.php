...
?>
    ...
    <div>
        ...
        <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 80%;" aria-valuenow="" aria-valuemin="" aria-valuemax="100">80%</div>
        </div>

        <h3 class="mb-4 mt-2">Etape 5 - Les délais de vos vols internationaux (Retour).</h3>

        <form id="contactForm" action="" method="POST">

        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text">N° de vol (Retour)</span>
            </div>
            <input name="numvol" class="form-control" placeholder="N° de vol (Retour)">
        </div>
        ...
        <button type="submit" formaction="index.php?useCase=devis&action=formulaire6" name="submit" class="btn btn-outline-success" >Suivant</button>
